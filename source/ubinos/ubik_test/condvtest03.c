...
int ubik_test_condvtest03(void) {
	...
	r = task_create(&_g_ubik_test_task_a[3-1], condvtest03_task3func, NULL, task_getpriority(NULL)-3, 0, "condvtest03 task 3");
	if (0 != r) {
	...
	r = task_create(&_g_ubik_test_task_a[1-1], condvtest03_task1func, NULL, task_getpriority(NULL)-1, 0, "condvtest03 task 1");
	if (0 != r) {
		printf("fail at task_create(), err=%d\r\n", r);
		r = -1;
		goto end3;
	...
	r = task_create(&_g_ubik_test_task_a[2-1], condvtest03_task2func, NULL, task_getpriority(NULL)-2, 0, "condvtest03 task 2");
	if (0 != r) {
		printf("fail at task_create(), err=%d\r\n", r);
		r = -1;
		goto end3;
