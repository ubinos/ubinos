...
common-help:
	...
	@echo ""
	@echo "make update                  (update libraries listed in LIBRARY_UPGRADE_LIST)"
	@echo "make updatef                 (update libraries listed in LIBRARY_UPGRADE_LIST with force option)"
	@echo "make updatea                 (update all libraries)"
	@echo "make updateaf                (update all libraries with force option)"
	@echo ""
	@echo "-------------------------------------------------------------------------------"
	@echo ""
